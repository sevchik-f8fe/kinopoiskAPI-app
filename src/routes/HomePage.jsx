    ...
    return (
        <div className="w-full dark:bg-zinc-800 py-4 flex justify-between gap-2">
            {data[0] ? (
                ...
                <div className="w-2/5 my-12 flex min-h-64 flex-col items-center justify-center mt-8">
        ...
        <>
            ...
            <div className="self-start top-12 sticky my-12 p-4 w-3/5 flex justify-between gap-1">
                <div className="relative w-3/5 px-2 py-1">
                    <h1 className="z-10 text-5xl font-bold mb-4 text-zinc-700 dark:text-white max-w-max">{showItem?.name}<span className="font-medium text-2xl"><br />{showItem?.year}</span></h1>
                    <span className="font-bold text-xl bg-green-200 dark:bg-green-700 dark:text-white p-1 rounded">{showItem?.rating?.imdb} imdb</span>
